...
# построение вектора квантового состояния |psi> для 4 кубитов в форме L_a2b2
def build_l_a2b2(a, b, c):
...
if all(abs(s) == 0 for s in single_entropies):
    is_fully_separable = True
else:
    print("Состояние не полностью сепарабельно. Продолжаю проверку.")
